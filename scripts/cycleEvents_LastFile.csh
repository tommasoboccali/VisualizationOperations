...
set lastfile=$directory_log/LastFile
if ($#argv <> 1) then
...
while (1)
  ...
  echo /afs/cern.ch/cms/CAF/CMSCOMM/COMM_GLOBAL/EventDisplay/RootFileTempStorageArea/temp1.root > $lastfile
  sleep 30
  cp $1 /afs/cern.ch/cms/CAF/CMSCOMM/COMM_GLOBAL/EventDisplay/RootFileTempStorageArea/temp2.root
  echo /afs/cern.ch/cms/CAF/CMSCOMM/COMM_GLOBAL/EventDisplay/RootFileTempStorageArea/temp2.root  > $lastfile 
  sleep 30
